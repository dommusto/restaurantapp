...
namespace RestaurantApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSignalR();
            services.AddSingleton<IOrderProcessManager>(new OrderProcessManager());
            ...
            services.AddBrighter(opts => opts.HandlerLifetime = ServiceLifetime.Singleton).HandlersFromAssemblies(typeof(PrepareOrderCommand).Assembly).HandlersFromAssemblies(typeof(OrderStatusUpdatedEventHandler).Assembly);
